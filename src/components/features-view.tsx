...
export function FeaturesView() {
  ...
  const features = [
    {
      ...
      desc: t("features.assessmentDesc", "Continuous cognitive evaluation adapting dynamically to user input patterns. AI-generated quizzes span all mapped competency domains and self-adjust difficulty based on your responses."),
    ...
    },
    {
      ...
      desc: t("features.learningDesc", "Algorithmic generation of custom curricula optimised for rapid comprehension, recommending iGOT / NSSTA courses matched to your exact skill gap profile."),
    ...
    },
    {
      ...
      desc: t("features.mappingDesc", "Multi-dimensional skill matrix generation for precise talent alignment and role readiness scoring against official NCS / DoPT competency frameworks."),
    ...
    },
    {
      ...
      desc: t("features.tutorDesc", "A conversational AI tutor guides you through complex statistical concepts with examples drawn from official Indian datasets — from GDP deflators to NSS survey design."),
    ...
    },
    {
      ...
      desc: t("features.analyticsDesc", "Org-wide competency heatmaps and trend analytics for training officers. Visualise workforce readiness across departments, ministries, and seniority bands at a glance."),
    ...
    },
    {
      ...
      desc: t("features.scoringDesc", "Instant, numerical readiness score for any target job role — benchmarked against the official NCS / DoPT competency framework — so officers know exactly where they stand."),
  ...
  const pillars = [
    ...
    { icon: Globe, label: "Multilingual Ready", desc: "Interface and content localisation powered by official Bhashini API." },
      ...
      <main className="pt-32 pb-24 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto space-y-32 min-h-[80vh]">
        ...
        <section id="features" className="text-center space-y-6 max-w-3xl mx-auto">
          ...
          <h1 className="font-display-lg-mobile text-display-lg-mobile md:font-display-lg md:text-display-lg font-bold text-on-surface tracking-tight">
            {t("home.featuresHeading", "Everything StatIQ AI Can Do")}
          </h1>
          <p className="font-body-lg text-body-lg text-on-surface-variant">
            {t("home.featuresSubtitle", "Built on a foundation of rigorous data science and machine learning logic. Nine purpose-built capabilities for India's statistical workforce.")}
          </p>
        </section>
        ...
        <section className="relative overflow-hidden rounded-3xl border border-white/10">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center text-center gap-6 py-20 px-8">
            <h2 className="font-display-lg-mobile text-display-lg-mobile font-bold text-on-surface tracking-tight">
              {t("home.startJourney", "Ready to Try It?")}
            </h2>
            <p className="font-body-lg text-body-lg text-on-surface-variant max-w-xl">
              {t("home.startJourneyDesc", "Experience all nine features in the interactive demo — no installation required.")}
            </p>
